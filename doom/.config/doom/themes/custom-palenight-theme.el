;;; custom-palenight-theme.el --- inspired by Material-Palenight -*- no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup custom-palenight-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom custom-palenight-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'custom-palenight-theme
  :type '(choice integer boolean))

;;
(def-doom-theme custom-palenight
  "A dark theme inspired by Material-Moonlight"

  ;; name        default   256       16
  ((bg         '("#1a1a28" nil       nil))
   (bg-alt     '("#141423" nil       nil))
   ...
   (-modeline-pad
    (when custom-palenight-padded-modeline
      (if (integerp custom-palenight-padded-modeline) custom-palenight-padded-modeline 4))))
...
(provide 'custom-palenight-theme)
