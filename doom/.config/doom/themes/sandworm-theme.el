;;; sandworm-theme.el --- inspired by Material-Palenight -*- no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup sandworm-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom sandworm-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'sandworm-theme
  :type '(choice integer boolean))

;;
(def-doom-theme sandworm
  "A dark theme inspired by Material-Moonlight"

  ;; name        default   256       16
  ((bg         '("#1b181f" nil       nil))
   (bg-alt     '("#1b181f" nil       nil))
   ...
   (red         '("#ec1e31" "#ff0000" "red"))
   (orange      '("#e58e5e" "#ff5f00" "brightred"))
   ...
   (-modeline-pad
    (when sandworm-padded-modeline
      (if (integerp sandworm-padded-modeline) sandworm-padded-modeline 4))))
